...
// pictureSource is object containing image data.
   ...
   // xhttp.setRequestHeader("Content-type", "application/image");
   // xhttp.send(dataURL);

   var url = "http://localhost:8002/";
   var httpPost = new XMLHttpRequest();

      // file = JSON.stringify(canvas);
       //file = canvas.toDataURL();
    
    httpPost.open("POST", url, true);
       //httpPost.setRequestHeader('Content-Type', 'json;charset=UTF-8');    
    httpPost.send(file);
       ...
       // console.log(typeof(file));
        ...
        if(httpPost.readyState == 4 && httpPost.status == 200) {
            var return_data = httpPost.responseText;
            console.log("retuen data is :");
